...
<html>    
    <!-------------------------Header Plugins ----------------------------->
     <title>School Library System | Teacher Registration</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        ...
                        <small>Teacher Details Handling</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Teacher Details Handling</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <!-- Main row -->
                    <div class="row">
                        <!-----------------------------------------------Teacher Registration Page Content-------------------------------------> 

                        <div class="col-md-12">                          
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h3 id="set-title" class="box-title">Add New Teacher</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form action="add_user.php" method="post" class="form-horizontal">    
                                    <div class="box-body">
										...
										<div class="form-group">
                                            <label for="c_name" class="col-sm-3 control-label">NIC</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="tnic" required name="tnic" placeholder="Teacher NIC Number" value="<?php echo $emailEdit; ?>">
                                            </div>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" id="taddress" name="taddress" rows="3" placeholder="Enter Teacher Address..."></textarea>
                                            </div>
                                        </div>
										
										<div class="form-group">
                                            <label for="c_name" class="col-sm-3 control-label">Mobile Number</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="tmobile" required name="tmobile" placeholder="Teacher Mobile Number" value="<?php echo $emailEdit; ?>">
                                            </div>
                                        </div>
										
										<div class="form-group">
                                            <label for="c_name" class="col-sm-3 control-label">Home Telephone</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="ttelephone" required name="ttelephone" placeholder="Teacher Home Telephone" value="<?php echo $emailEdit; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                ...
                                                <?php if ($edit_tag == 0) { ?>
                                                    <span id="show-create-btn"><button type="submit" name="save" class="btn btn-success">Add New Teacher</button></span>
                                                    <?php
                                                }
                                                if ($edit_tag == 1) {
                                                    ?>
                                                    <input type="hidden" name="uid" class='form-control' required value="<?php echo $uid; ?>" >
                                                    <span id="show-create-btn"><button type="submit" name="Update" class="btn btn-success">Update Teacher Details</button></span>
                                                <?php } ?>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Registered Teacher List </h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
