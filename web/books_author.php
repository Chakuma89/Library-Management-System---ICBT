                                    ...
                                    <table class="table table-bordered" id="author-tbl">
                                        ...
                                        foreach ($author->showAuthors("authors") as $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="books_author.php?editid=<?php echo $author_id; ?>">Edit</a> | <a href="books_author.php?deleteid=<?php echo $author_id; ?>" onclick="return confirm('Are you sure?');">Delete</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </table>
